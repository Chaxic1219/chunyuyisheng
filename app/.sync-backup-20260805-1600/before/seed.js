...
const WANG_HOME_MP_CODES = ["101", "102", "301", "909"];
const WANG_CY = {
...
const zhouyuchun = {
  ...
  rules: [
    ...
    },
    {
      ...
      // 两张医院小程序贴片（模板码 626a/626b；626a 与 103 同短链可复用封面，626b 需对该短链采集一次）。
      responses: [
...
const wangyuncheng = {
  ...
  content: {
    ...
    menu: { title: "群功能菜单", items: [
      ...
      { code: "626", label: "就医常见问题" }, { code: "818", label: "医生介绍给亲友" },
